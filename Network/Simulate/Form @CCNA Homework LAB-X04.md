...
![](Image/Pasted%20image%2020260424105654.png)

**รูปที่ 2:** รายละเอียดการเชื่อมต่อเข้าสู่ CDP Cloud
![](Image/Pasted%20image%2020260424105745.png)

**รูปที่ 3:** การใช้คำสั่งตรวจสอบอุปกรณ์ข้างเคียง (CDP Neighbors)
![](Image/Pasted%20image%2020260424110705.png)
...
- **Common Problem:** มองไม่เห็นเพื่อนบ้าน ทั้งที่สายแลนเชื่อมต่อกันอยู่
- **Solution:** ตรวจสอบว่าอินเทอร์เฟซนั้นถูกปิดอยู่หรือไม่ หรือมีการใช้คำสั่ง `no cdp run` (ปิดทั้งเครื่อง) หรือ `no cdp enable` (ปิดเฉพาะพอร์ต) ไว้หรือไม่
- **Verification:**
    - ใช้คำสั่ง `show cdp neighbors` เพื่อดูรายชื่ออุปกรณ์แบบย่อ
    - ใช้คำสั่ง `show cdp neighbors detail` เพื่อดู IP Address และ Version ของ IOS ของเพื่อนบ้าน ซึ่งช่วยในการรีโมทไปจัดการต่อได้ง่ายขึ้น
