...
1.  **การส่งข้อมูล (Transmission):** อะแดปเตอร์ไร้สายของคอมพิวเตอร์จะแปลงข้อมูลเป็นสัญญาณวิทยุและส่งออกไปโดยใช้เสาอากาศ
    (A computer's wireless adapter translates data into a radio signal and transmits it using an antenna.)![](../IMG/Dipole_xmting_antenna_animation_4_408x318x150ms.gif)
...
![](../IMG/Pasted%20image%2020260505104155.jpg)
![](../IMG/Pasted%20image%2020260505104213.jpg)

### 2. 802.11a (หลังจาก 802.11b)
-   **ความเร็ว:** สูงสุด 54 Mbps
-   **ความถี่:** 5 GHz
-   **เทคโนโลยี:** ใช้ **OFDM (Orthogonal Frequency-Division Multiplexing)** ซึ่งเป็นเทคนิคการเข้ารหัสที่มีประสิทธิภาพมากขึ้น โดยการแยกสัญญาณวิทยุออกเป็นสัญญาณย่อยหลายๆ สัญญาวนเพื่อลดการรบกวน
    (Uses OFDM to split radio signals into sub-signals, greatly reducing interference.)

![](../IMG/OFDM_Signal_-_Freq-Time_Representation_12-11-23_email_hero_2.webp)
